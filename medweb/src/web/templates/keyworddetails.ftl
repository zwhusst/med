<p><img src="image/triangle.gif">&nbsp;&nbsp;<a href="${baseHref}${detailsData.searchAllURL}">查询&nbsp;
...
<p><img src="image/triangle.gif">&nbsp;&nbsp;<a href="${baseHref}${detailsData.simpleSearchURL}">仅仅查询&nbsp;${detailsData.keyword.name}</a></p>
<hr>
