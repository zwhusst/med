...
<div style="position:absolute;right: 0px;top:340px;text-align: left;background-color:#0065a4;width: 165px;padding: 3px 3px 30px 3px;">
  <div style="line-height: 40px;text-align: center;color: white;padding-top: 10px;">
    <a style="background:#42a8d3;padding: 11px 10px 11px 10px;cursor: pointer;color: white;" onclick='javascript:showModalDialog("consultant.html", "consulting_dialog", {"width":710,"height": 410,"dialogClass":"consulting_dialog", "resizable": false, "title":"寻求帮助"})'>
    寻求更多帮助
    </a>
  </div>
  <div style="font-size: 12px;color: white;padding:10px 5px 5px 10px;">您有任何困难和建议，<br>尽请告诉我们，<br>愿我们专业的个性化健康咨询服务能更好的服务您！</div>
  <div style="text-align: center;border-top: 1px solid #ccc;margin: 6px 10px 0 10px;"><img src='image/ttd_wechat.jpg' style="width: 140px;padding-top:10px"/></div>
  <div style="color: white;font-size: 13px;padding: 10px 0px 0px 10px;">手机扫描加关注<br>第一时间获得健康帮助<br></div>
  <div style="color: white;font-size: 13px;padding: 10px 0px 0px 10px;">公众帐号：健康咨询-天天动<br>微信号：ttdong_com_cn</div>
</div>
