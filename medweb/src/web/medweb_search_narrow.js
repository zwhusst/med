(function(){
  ...
  var html = [
    ...
    '&nbsp;',
    '<input style="vertical-align: middle; width: 30px" type="submit" value="搜索" />',
    '<br>',
